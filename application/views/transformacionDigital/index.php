<main>
    ...
    <section id="curso" class="div-seccion-intro more-features-area pb-80" style="background-color: #EDEDEE !important;">
        <div class="container" style="margin-top: -6rem;position: relative;z-index: 2;">
            <div class="row equal-cols espacio-cards" style="display: flex;">
                <div class="detalles-card col-lg-4 col-md-2 col-xs-6"> 
                    <div class="fea-item wow fadeInUp" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeInUp;background-color:#625D5E">
                        ...
                        <div class="container" style="margin-bottom: 25px;">
                            <div class="row content">
                                ...
                                <div class="col-md-12 descripcionTarjeta" style="padding-top: 10px;">
                                    ...
                                    <span style="font-size: 16px;font-weight: 500;line-height: 20px;color: #FFFFFF;font-family: 'AdelleSans-Reg';">Aún no tenemos</span>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <section id="requisitos" class="section-padding wow fadeInUp animate__fast bg-emtech2 pb-80">
        <div class="container py-5">
            ...
            <div class="row p-2" >
                <div class="col-12">
                    <div class="carruselRequisitos">
                        <div class="row p-5">
                            <div id="paso1" class="col tarjeta-pasos" style="height:15rem;width: 355px;">
                        ...
                        <div class="row p-5">
                            <div id="paso1" class="col tarjeta-pasos" style="height:15rem;width: 340px;">
                                <div id="paso1m" class="" style="text-align:left ">
                                    <div class="row">
                                        <div class="col-12">
